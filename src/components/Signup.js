                            ...
                            <div className="card shadow-2-strong" style={{ borderRadius: "1rem" }}>
                                <div className="card-body p-5 text-center">
                                    ...
                                    <div className="form-outline mb-4">
                                        <input type="text" className="form-control form-control-lg" placeholder="username" name="username" value={data.username} onChange={(e) => { handleChange(e) }} />
                                    </div>
                                    <div className="form-outline mb-4">
                                    ...
                                    <button className="btn btn-primary w-50 btn-lg btn-block" type="submit">Sign Up</button>
                                    <hr className="my-4" />
